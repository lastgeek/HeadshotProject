...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_AHPRifleWeapon()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_WeaponFXComponent = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("WeaponFXComponent"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(WeaponFXComponent, AHPRifleWeapon), 0x00100000000a001d, Z_Construct_UClass_UHPWeaponFXComponent_NoRegister());
				...
				MetaData->SetValue(NewProp_WeaponFXComponent, TEXT("Category"), TEXT("VFX"));
				MetaData->SetValue(NewProp_WeaponFXComponent, TEXT("EditInline"), TEXT("true"));
				MetaData->SetValue(NewProp_WeaponFXComponent, TEXT("ModuleRelativePath"), TEXT("Public/Weapon/HPRifleWeapon.h"));
	...
	IMPLEMENT_CLASS(AHPRifleWeapon, 2146175168);
