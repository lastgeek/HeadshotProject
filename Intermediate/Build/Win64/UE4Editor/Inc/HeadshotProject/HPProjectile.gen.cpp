...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_AHPProjectile()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_WeaponFXComponent = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("WeaponFXComponent"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(WeaponFXComponent, AHPProjectile), 0x00100000000a001d, Z_Construct_UClass_UHPWeaponFXComponent_NoRegister());
				...
				MetaData->SetValue(NewProp_WeaponFXComponent, TEXT("ModuleRelativePath"), TEXT("Public/Weapon/HPProjectile.h"));
	...
	IMPLEMENT_CLASS(AHPProjectile, 1301310528);
